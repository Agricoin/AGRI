...
#define QAPP_ORG_NAME "agricoin"
#define QAPP_ORG_DOMAIN "agricoin.com"
#define QAPP_APP_NAME_DEFAULT "agricoin-Qt"
#define QAPP_APP_NAME_TESTNET "agricoin-Qt-testnet"
