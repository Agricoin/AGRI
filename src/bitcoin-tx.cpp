...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s agricoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  agricoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded agricoin transaction") + "\n" +
              "  agricoin-tx [options] -create [commands]   " + _("Create hex-encoded agricoin transaction") + "\n" +
              "\n";
